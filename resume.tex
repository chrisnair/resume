...
\section{\textbf{Experience}}
  ...
  \resumeSubheading
      {Collins Aerospace (RTX Corporation)}{Cedar Rapids, IA}
      {Software Engineering Intern}{May 2024 - Present}
    \resumeItemListStart
      \item{Performed work as 1 of 40 selected nationwide for RTX's self-directed Summer Engineering Project Program}
      \item{Implemented scalable SQL Server relational database supporting 100,000+ records}
      \item{Full project ownership to take department's internal data from 8 spreadsheets to one centralized DB}
      \item{Engineered frontend via ASP.NET Core Blazor to support import, export, and validation}
      \item{Implemented security via OAuth 2.0 and role-based access control integration with internal 2FA \& GUI}
    \resumeItemListEnd
